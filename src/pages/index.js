    ...
    return (
        <div>
            ...
            <div className="header">
                <ScrollAnimation animateIn="fadeInLeft" animateOut="fadeOutLeft" offset={25} duration={2}>
                    <h1 className="header-text">FULL STACK</h1>
                </ScrollAnimation>
                <ScrollAnimation animateIn="fadeInRight" animateOut="fadeOutRight" offset={25} duration={2}>
            ...
            <ScrollAnimation animateIn="fadeInLeft" animateOut="fadeOutLeft" offset={25}>
            ...
            <ScrollAnimation animateIn="fadeInRight" animateOut="fadeOutRight" offset={25}>
            ...
            <div className="contact">
                ...
                <div className="contact-social">
                    <div className="contact-social-inner">
                        ...
                        <div className="contact-link-container"><a href="/" className="contact-social-link">Twitter,</a></div>
                        <div className="contact-link-container"><a href="/" className="contact-social-link">Instagram,</a></div>
                        <div className="contact-link-container"><a href="/" className="contact-social-link">Linkedin,</a></div>
                        <div className="contact-link-container"><a href="/" className="contact-social-link">Github,</a></div>
                        <div className="contact-link-container"><a href="/" className="contact-social-link">Medium</a></div>
                    </div>
                </div>
